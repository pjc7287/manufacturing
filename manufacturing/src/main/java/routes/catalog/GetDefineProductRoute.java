 ...
 */
public class GetDefineProductRoute implements Route {

    private TemplateEngine templateEngine;
    private Database db;


    public GetDefineProductRoute(TemplateEngine templateEngine, Database db){
    ...
    public Object handle(Request request, Response response){
        ...
        if(userSession.attribute("signedIn")=="true"){
            ...
            return templateEngine.render(new ModelAndView(attributeMap , "catalog/define_product.ftl"));
        }
        else{
